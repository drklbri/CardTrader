...
from .views import CardAPIView, CardDetailAPIView, CardByAnnouncementAPIView, CardSearchAPIView, TagAPIView, \
    TagDetailAPIView, CollectionAPIView, CollectionDetailAPIView
