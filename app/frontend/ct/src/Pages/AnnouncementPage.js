...
const AnnouncementPage = () => {
    ...
    useEffect(() => {
        const fetchUser = async () => {
            ...
            if (currentUser && currentUser.username) {
                try {
                    const userResponse = await axios.get(`https://card-trader.online/api/auth/user/login/${currentUser.username}`);
    ...
    useEffect(() => {
        ...
        const fetchAnnouncement = async () => {
            try {
                const response = await axios.get(`https://card-trader.online/api/announcements/${id}`);
        ...
        const fetchComments = async () => {
            try {
                const response = await axios.get(`https://card-trader.online/api/comments/announcement/${id}`);
                ...
                const avatarPromises = response.data.map(async (comment) => {
                    if (comment.name) {
                        try {
                            const avatarResponse = await axios.get(`https://card-trader.online/api/auth/user/login/${comment.name}`);
    ...
    const handleSubmitComment = async () => {
        ...
        try {
            ...
            await axios.post('https://card-trader.online/api/comments', commentData, {
                headers: {
    ...
    const handleSubmitChanges = async () => {
        try {
            ...
            await axios.put(`https://card-trader.online/api/announcements/${id}/`, {
            ...
            for (const cardId of announcement.cards) {
                await axios.put(`https://card-trader.online/api/cards/${cardId}/`, {
    ...
    return (
        <div className="announcement-page-container">
            ...
            <div className="announcement-details-ad">
